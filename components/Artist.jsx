...
import FansAlsoLike from './Artist/FansAlsoLike';
import Singles from './Artist/Singles';
    ...
    return (
        <View className="flex-1 bg-black relative">
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <View className="px-2 active:bg-white/0 ">
                ...
                ListFooterComponent={() => (
                    <View className='flex-col gap-6'>
                        ...
                        <Singles artist={artist} />
                        <Videos artist={artist} />
                        <About artist={artist} />
                        <FansAlsoLike artist={artist} />
